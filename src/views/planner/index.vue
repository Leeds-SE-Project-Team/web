...
<template>
  ...
  <section class="sider">
    ...
    <a-form ref="formRef" :rules="rules" :model="createTourForm" :style="{ width: '388px' }" @submit="handleCreateTour">
      <div class="top">
        ...
        <div class="tool">
          <a-collapse accordion expand-icon-position="right">
            <a-collapse-item key="1" :style="customStyle" header="Sports">
              <div class="items">
                <div class="item walk" @click="createTourForm.type = TourType.WALK"
                  :class="[createTourForm.type === TourType.WALK ? 'svg-grew' : 'svg-white']">
                  <svg t="1710074674268" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="2737">
                    <path
                      ...
                      p-id="2738" fill="#ffffff">
                    </path>
                  </svg>
                </div>

                <div class="item" @click="createTourForm.type = TourType.CYCLING"
                  :class="[createTourForm.type === TourType.CYCLING ? 'svg-grew' : 'svg-white']">
                  <svg t="1710074828341" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="7408">
                    <path
                      ...
                      p-id="7409" fill="#ffffff">
                    </path>
                  </svg>
                </div>

                <div class="item car" @click="createTourForm.type = TourType.CAR"
                  :class="[createTourForm.type === TourType.CAR ? 'svg-grew' : 'svg-white']">
                  <svg t="1710075402574" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="8606">
                    <path
                      ...
                      p-id="8607" fill="#ffffff">
                    </path>
                  </svg>
                </div>

                <div class="item public" @click="createTourForm.type = TourType.PUBLIC"
                  :class="[createTourForm.type === TourType.PUBLIC ? 'svg-grew' : 'svg-white']">
                  <svg t="1710075911174" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="10030">
                    <path
      ...
      <div class="middle">
        ...
        <div class="place">
          <div>
            <a-form-item field="startLocation" validate-trigger="blur">
              <a-input v-model.trim:model-value="createTourForm.startLocation" allow-clear class="place-input"
                placeholder="Enter Starting Point" @change="console.log(createTourForm.startLocation)">
          ...
          <div>
            <a-form-item field="endLocation" validate-trigger="blur">
              <a-input v-model.trim:model-value="createTourForm.endLocation" allow-clear class="place-input"
        ...
        <div class="icons-part">
          ...
          <div class="right-icon">
            <svg aria-hidden="true" class="css-rjl6tn" fill="none" role="presentation" viewBox="0 0 24 24"
