...
const handleCreateTour = () => {
  console.log(createTourForm.value)
  setLoading(true)
  ...
  <section class="sider">
    ...
    <a-form ref="formRef" :rules="rules" :model="createTourForm" :style="{width:'388px'}" @submit="handleCreateTour">
        ...
        <div class="tool">
          <a-collapse accordion expand-icon-position="right">
            <a-collapse-item key="1" :style="customStyle" header="Sports">
              <div class="items">
                <div class="item walk" @click="createTourForm.type = TourType.WALK" :class="[createTourForm.type===TourType.WALK ? 'svg-grew' : 'svg-white']">
                  <svg
                  t="1710074674268" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2737">
                    <path 
                ...
                <div class="item" @click="createTourForm.type = TourType.CYCLING" :class="[createTourForm.type===TourType.CYCLING ? 'svg-grew' : 'svg-white']">
                  <svg
                  t="1710074828341" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7408">
                    <path 
                ...
                <div class="item car" @click="createTourForm.type = TourType.CAR" :class="[createTourForm.type===TourType.CAR ? 'svg-grew' : 'svg-white']">
                  <svg
                  t="1710075402574" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8606">
                    <path 
                ...
                <div class="item public" @click="createTourForm.type = TourType.PUBLIC" :class="[createTourForm.type===TourType.PUBLIC ? 'svg-grew' : 'svg-white']">
                  <svg
                  t="1710075911174" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="10030">
                    <path 
      ...
      <div class="middle">
        ...
        <div class="place">
          <div>
            <a-form-item field="start" validate-trigger="blur">
              <a-input
          ...
          <div>
            <a-form-item field="end" validate-trigger="blur">
              <a-input
