    ...
    <div id="page-collection-detail">
        ...
        <div class="header-cover">
            <div class="img-wrapper">
                <img src="http://walcraft.wmzspace.space/static//tour/example/4.png" alt="">
            </div>
        </div>
        <div class="content">
            ...
            <div class="user flex-r flex-justify-c">
                <div class="info-wrapper flex-c">
                    <div class="avatar-wrapper flex-r flex-justify-c">
                        <a-avatar>
                            <img
                                src="//fp1.fghrsh.net/2023/05/16/b082833e5c59a309880eca3d525e7cae.gif"
                                alt=""
                            >
                        </a-avatar>
                    </div>
        ...
        <div ref="scrollContainer" class="tour-scroll-container">
            ...
            <div>
                <div class="img-wrapper">
                    <img :src="testCardInfo.spots[0].coverUrl" alt="">
                </div>
                <div class="img-wrapper">
                    <img :src="testCardInfo.spots[1].coverUrl" alt="">
                </div>
                <div class="img-wrapper">
                    <img :src="testCardInfo.spots[2].coverUrl" alt="">
                </div>
                <div class="img-wrapper">
                    <img :src="testCardInfo.spots[0].coverUrl" alt="">
                </div>
...
import { TourType, type TourRecord } from '@/apis/tour';
...
onMounted(()=>{
    if(tourScroll.value && scrollContainer.value){
        const imgs = scrollContainer.value.getElementsByClassName('img-wrapper') as HTMLCollectionOf<HTMLDivElement>;
