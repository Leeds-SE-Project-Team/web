export default {
  ...
  'searchTable.user.form.authorId': '作者编号',
  ...
  'searchTable.user.form.contentType': '出行方式',
  ...
  'searchTable.user.form.name.placeholder': '请输入集合名称',

  'searchTable.user.form.filterType.rules': '规则筛选',
  'searchTable.user.form.publishTime': '发布时间',
  'searchTable.user.form.status': '状态',
  'searchTable.user.form.status.online': '已上线',
  'searchTable.user.form.status.awaitApproval': '待审核',
  'searchTable.user.form.status.offline': '已下线',

  'searchTable.user.form.search': '查询',
  'searchTable.user.form.reset': '重置',
  'searchTable.user.form.selectDefault': '全部',
  'searchTable.user.operation.create': '发布',
  ...
  'searchTable.user.columns.contentType': '出行方式',
  'searchTable.user.columns.filterType': '筛选方式',
  'searchTable.user.columns.likeCount': '点赞量',
  'searchTable.user.columns.starCount': '收藏量',
  'searchTable.user.columns.commentCount': '评论量',
  'searchTable.user.columns.publishTime': '创建时间',
  'searchTable.user.columns.status': '状态',
  'searchTable.user.columns.operations': '操作',
  'searchTable.user.columns.operations.view': '查看',
  'searchTable.user.columns.operations.delete': '删除',
  'searchTable.user.columns.operations.offline': '下线',
  'searchTable.user.columns.operations.online': '上线',
