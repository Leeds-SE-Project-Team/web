<template>
  <transition name="slide-y-up-transition" :duration="animationDuration">
    <div
      class="modal fade"
...
.slide-y-up-transition-enter-active,
.slide-y-up-transition-leave-active {
  transition: transform 0.5s;
}
.slide-y-up-transition-enter,
.slide-y-up-transition-leave-to {
